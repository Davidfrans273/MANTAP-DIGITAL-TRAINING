        ...
        if(isset($_POST["login"])){
            ...
            if (mysqli_num_rows($hasil) > 0){
             ...
             if($password == $data["passwords"]){
                    header("Location: home.php? statusz=loginberhasil");
            } else {
...
<title>Login - Mantap Digital Training</title>
<style>
    :root {
        --hijau-tua: #14532d;
        --hijau: #1a6b45;
...
<div class="login-wrapper">
    <div class="login-card">
        ...
        <form method="POST" action="">
            ...
            <a href="register.php" style="margin-top : 5px; display: inline-block">Belum Punya Akun?</a>
        </form>
    </div>
</div>
</body>
